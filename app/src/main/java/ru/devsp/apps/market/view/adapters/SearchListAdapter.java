...
/**
 * Адаптер для списка товаров в поиске
 * Created by gen on 19.12.2017.
 */

public class SearchListAdapter extends RecyclerViewAdapter<SearchGood, SearchListAdapter.Holder> {

    private String mPricePattern;

    public SearchListAdapter(List<SearchGood> items, String pricePattern) {
        super(items);
    ...
    public void onBindViewHolder(Holder holder, int position) {
        SearchGood item = mItems.get(position);
